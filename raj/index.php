...
<main class="spa-main">
  ...
  <section class="spa-slide" id="tab-react">
      <a href="hotel/index.php"><div class="tab1"><h1>HOTEL</h1></div></a>
  ...
  <section class="spa-slide" id="tab-vue">
      <a href="guide/index.php"><div class="tab3"><h1>Guide</h1></div></a>
   </section>
  <section class="spa-slide" id="tab-last">
      <a href="yoga_trainer/index.php"><div class="tab4"><h1>YOGA TRAINER</h1></div></a>
      <a href="masseur/index.php"><div class="tab4"><h1>MASSEUR</h1></div></a>
      <a href="reiki_trainer/index.php"><div class="tab4"><h1>REIKI TRAINER</h1></div></a>
      <a href="tatoo_artist/index.php"><div class="tab4"><h1>TATTOO ARTIST</h1></div></a>
   </section>
